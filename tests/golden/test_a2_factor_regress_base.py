"""
Golden test: a2_factor_regress_base

Tests Stata factor-variable base-level syntax alignment for ``regress`` with
...
class TestA2FactorRegressBase:
    ...
    def python_result(self, test_data):
        return regress(test_data, y="y", x=["ib2.g##c.x1"])
