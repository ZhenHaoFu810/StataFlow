"""
Golden test: w12_slopes_basic - slope absorption (synthetic).
...
def _run_stata(data: pd.DataFrame) -> dict:
    """Run Stata reghdfe with slope absorption."""
    dta_file = PROJECT_STATA_CASES / "w12_slopes_basic_data.dta"
...
display "Stata slopes basic completed successfully"
'''
    runner = StataRunner()
