"""Golden dual-run test: margins on real Mroz data."""
...
def test_margins_logit_mroz():
    """Logit margins dydx and atmeans on Mroz data."""
    df = _load_data()

    dta_file = PROJECT_STATA_CASES / "w5_margins_logit_mroz_data.dta"
...
"""
    ...
    for name in ["nwifeinc", "educ", "exper", "expersq", "age", "kidslt6", "kidsge6"]:
