"""
Golden test: a2_factor_logit_base

Tests Stata factor-variable base-level syntax alignment for ``logit`` with
a categorical-continuous full interaction ``ib2.g##c.x1``.
"""
...
class TestA2FactorLogitBase:
    ...
    def python_result(self, test_data):
        return logit(test_data, y="y_bin", x=["ib2.g##c.x1"])
