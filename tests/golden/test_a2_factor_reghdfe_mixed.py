"""
Golden test: a2_factor_reghdfe_mixed

Tests Stata factor-variable syntax alignment for ``reghdfe`` with
a mixed-order categorical-continuous full interaction ``c.x1##i.g``
and two absorbed fixed effects.
"""
...
reghdfe y c.x1##i.g, absorb(firm year)
...
class TestA2FactorReghdfeMixed:
    ...
    def python_result(self, test_data):
        return reghdfe(test_data, y="y", x=["c.x1##i.g"], absorb="firm year")
