"""
Full exploration of xtreg, fe to understand all statistical details.
"""
...
def main():
    ...
    dta_file = TEMP_DIR / "p2_fe_full.dta"
...
'''.replace("$DATA_FILE", str(dta_file))
    ...
    for name, pattern in [
        ...
        ('F_p', r'E_F_p=([\d.]+)'),
        ('rss', r'E_RSS=([\d.]+)'),
        ('sigma_u', r'E_SIGMA_U=([\d.]+)'),
        ('sigma_e', r'E_SIGMA_E=([\d.]+)'),
    ]:
