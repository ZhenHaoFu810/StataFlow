"""
Golden test: a2_factor_regress_bare

Tests Stata factor-variable syntax alignment for ``regress`` with
bare continuous variables in a full interaction ``x1##x2``.
"""
...
class TestA2FactorRegressBare:
    ...
    def python_result(self, test_data):
        return regress(test_data, y="y", x=["x1##x2"])
