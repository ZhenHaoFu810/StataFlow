"""
Golden test: w3_probit_real - Probit on Mroz labor force participation data.
...
def _run_stata_probit(data: pd.DataFrame) -> dict:
    """Run Stata probit on Mroz data."""
    dta_file = PROJECT_STATA_CASES / "w3_probit_real_data.dta"
...
display "Stata probit real completed successfully"
'''
    runner = StataRunner()
...
class TestW3ProbitReal:
    """Golden test for w3_probit_real."""
