...
with open("D:/OneDrive - SAIF/PhD3/StataFlow/stata/output/phase2/test_savefe.do", "r", encoding="utf-8") as f:
    content = f.read()
...
if result.output_content:
    with open("D:/OneDrive - SAIF/PhD3/StataFlow/stata/output/phase2/test_savefe.log", "w", encoding="utf-8") as f:
