...
runner = StataRunner()
output_dir = str(Path("stata/output").resolve())
...
with open("stata/output/wagepan_log3.txt", "w", encoding="utf-8") as out:
    out.write(txt)

with open("stata/output/wagepan_meta3.txt", "w", encoding="utf-8") as f:
