...
This folder is the public entry point for the validation evidence book.
...
Validation runners are kept in:
...
The public evidence book emphasizes real public-data dual runs against Stata 17. Development-time synthetic tests remain in the codebase for regression protection, but they are not the main public proof layer in this release copy.
