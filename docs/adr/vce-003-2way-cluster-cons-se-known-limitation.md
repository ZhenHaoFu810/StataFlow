...
- `tests/golden/test_w7_reghdfe_2way_cluster.py`：17 passed。
- `tests/golden/test_w7_reghdfe_2way_cluster_real.py`：15 passed。
- `tests/golden/test_w12_map_small_sample.py`：7 passed，MAP 与 LSDV 在 OLS、robust、cluster 场景按机器精度一致。
