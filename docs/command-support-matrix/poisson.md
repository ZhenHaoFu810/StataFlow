...
- Synthetic cases: Stata validation case `w3_poisson_basic`
- Real-data cases: Stata validation case `w3_poisson_real`
- Margins cases: Stata validation case `w5_margins_real_crime1`
