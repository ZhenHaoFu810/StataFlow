...
- Synthetic cases: Stata validation case `w2_ivregress_basic`, Stata validation case `w2_ivregress_cluster`
- Real-data cases: Stata validation case `w2_ivregress_real_card`
- Validated by Stata 17 comparison for 2SLS with conventional, robust, and cluster-robust VCE
