...
**timer clear
set rmsg on
reghdfe y x1 x2, a(id1 id2) tol($tol) tech(map) accel(cg) transf(sym) // nosample dof(none) fastreg timeit
creghdfe y x1 x2, a(id1 id2) dof(none) tol($tol)
exit
