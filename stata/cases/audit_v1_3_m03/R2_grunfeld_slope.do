clear all
set more off
import delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m03\R2_grunfeld_slope.csv", varnames(1) clear
which reghdfe
reghdfe invest mvalue, absorb(firm_id##c.year) vce(cluster firm_id)
display "E_N=" e(N)
