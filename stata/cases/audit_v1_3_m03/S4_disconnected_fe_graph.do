...
import delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m03\S4_disconnected_fe_graph.csv", varnames(1) clear

which reghdfe

reghdfe y x, absorb(firm year) vce(ols)
