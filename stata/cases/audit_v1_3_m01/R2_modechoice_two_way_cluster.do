...
import delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m01\R2_modechoice_two_way_cluster.csv", varnames(1) clear

regress choice ttme invc invt gc hinc, vce(cluster individual mode)
