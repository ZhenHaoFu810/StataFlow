clear all
set more off
import delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m04\S2_random_2sls_cluster.csv", varnames(1) clear
ivregress 2sls y w (x = z), cluster(g)
display "E_N=" e(N)
