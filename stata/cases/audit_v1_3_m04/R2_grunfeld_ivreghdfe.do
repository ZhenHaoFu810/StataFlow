clear all
set more off
import delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m04\R2_grunfeld_ivreghdfe.csv", varnames(1) clear
which ivreghdfe
ivreghdfe invest (mvalue = kstock), absorb(firm_id year) cluster(firm_id)
display "E_N=" e(N)
