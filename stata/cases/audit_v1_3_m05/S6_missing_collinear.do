clear all
set more off
import delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m05\S6_missing_collinear.csv", varnames(1) clear
logit y x1 x2 x3, vce(cluster g)
display "E_N=" e(N)
...
replace __dev_i = -2*ln(__mu) if e(sample) & y==1
replace __dev_i = -2*ln(1-__mu) if e(sample) & y==0
