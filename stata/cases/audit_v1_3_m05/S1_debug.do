clear all
set more off
import delimited "stata\cases\audit_v1_3_m05\S1_hand_computable_logit.csv", varnames(1) clear
logit y x
display "E_N=" e(N)
...
capture local dev = e(deviance)
if _rc == 0 & !missing(`dev') {
    display "E_DEVIANCE=" `dev'
}
if e(N_clust) < . {
