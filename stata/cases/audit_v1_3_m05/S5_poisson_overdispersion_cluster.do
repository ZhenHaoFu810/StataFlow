clear all
set more off
import delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m05\S5_poisson_overdispersion_cluster.csv", varnames(1) clear
poisson y x1 x2, vce(cluster g)
display "E_N=" e(N)
