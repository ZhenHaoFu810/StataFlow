...
set more off
webuse mroz, clear
export delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m05\R1_mroz_logit_robust.csv", replace nolabel
logit inlf age educ kidslt6 kidsge6, vce(robust)
display "E_N=" e(N)
...
replace __dev_i = -2*ln(__mu) if e(sample) & inlf==1
replace __dev_i = -2*ln(1-__mu) if e(sample) & inlf==0
