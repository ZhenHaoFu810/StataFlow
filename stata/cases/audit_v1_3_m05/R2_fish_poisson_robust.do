...
set more off
webuse fish, clear
export delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m05\R2_fish_poisson_robust.csv", replace nolabel
poisson count livebait camper persons child, vce(robust)
display "E_N=" e(N)
...
replace __dev_i = 2*(__mu) if e(sample) & count==0
replace __dev_i = 2*(count*ln(count/__mu) - (count - __mu)) if e(sample) & count>0
