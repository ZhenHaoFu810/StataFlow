clear all
set more off
import delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m05\S7_aweight_poisson.csv", varnames(1) clear
poisson y x1 x2 [aweight=w]
display "E_N=" e(N)
...
replace __dev_i = 2*(__mu) if y==0
replace __dev_i = 2*(y*ln(y/__mu) - (y - __mu)) if y>0
