...
set more off
sysuse nlsw88
export delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m05\R3_nlsw88_logit_cluster.csv", replace nolabel
logit collgrad age grade tenure married smsa, vce(cluster industry)
display "E_N=" e(N)
...
replace __dev_i = -2*ln(__mu) if e(sample) & collgrad==1
replace __dev_i = -2*ln(1-__mu) if e(sample) & collgrad==0
