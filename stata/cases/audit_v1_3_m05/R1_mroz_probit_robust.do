...
set more off
webuse mroz, clear
export delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m05\R1_mroz_probit_robust.csv", replace nolabel
probit inlf age educ kidslt6 kidsge6, vce(robust)
display "E_N=" e(N)
