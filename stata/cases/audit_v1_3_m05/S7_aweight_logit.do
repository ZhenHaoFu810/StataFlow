clear all
set more off
import delimited "D:\OneDrive - SAIF\PhD3\StataFlow\stata\cases\audit_v1_3_m05\S7_aweight_logit.csv", varnames(1) clear
logit y x1 x2 [aweight=w]
display "E_N=" e(N)
...
predict double __mu, pr
gen double __dev_i = 0
replace __dev_i = -2*ln(__mu) if y==1
replace __dev_i = -2*ln(1-__mu) if y==0
